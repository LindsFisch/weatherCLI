...
### Overview
Created a node js application that uses the weather-js npm package to pull the weather from a specific location provided by the user. Saves user data and location search and allows for reading the log file. 

### Specifications
Implement the logic for the `WeatherAdmin` component. 
